...
/*Create 2 buttons*/
lv_obj_t * back_btn = lv_btn_create(scr, NULL);         /*Create a button on the screen*/
lv_btn_set_fit(back_btn, true, true);                   /*Enable automatically setting the size according to content*/
lv_obj_set_pos(back_btn, 60, 40);              	   /*Set the position of the button*/

lv_obj_t * btn2 = lv_btn_create(scr, back_btn);         /*Copy the first button*/
lv_obj_set_pos(btn2, 180, 80);                    /*Set the position of the button*/

/*Add labels to the buttons*/
lv_obj_t * label1 = lv_label_create(back_btn, NULL);	/*Create a label on the first button*/
