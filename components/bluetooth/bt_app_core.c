...
bool
bt_app_work_dispatch(bt_app_cb_t p_cback, uint16_t event, void *p_params, int param_len, bt_app_copy_cb_t p_copy_cback)
{
...
void bt_app_task_start_up(void)
{
    ...
    xTaskCreatePinnedToCore(bt_app_task_handler, "BtAppTask", 4096, NULL, 20, &s_bt_app_task_handle, 0);
}
